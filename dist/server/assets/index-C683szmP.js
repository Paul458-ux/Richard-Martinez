...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: `fixed top-0 inset-x-0 z-50 transition-all ${scrolled ? "backdrop-blur-xl bg-background/70 border-b border-border" : "bg-transparent"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 h-16 flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-8 text-sm", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${l.toLowerCase()}`, className: "text-muted-foreground hover:text-cyan-glow transition-colors", children: l }) }, l)) })
  ] }) });
}
...
function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "home", className: "relative min-h-screen flex items-center justify-center overflow-hidden pt-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-12 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { variant: "spinner", delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center mx-auto", style: { width: 440, height: 440, maxWidth: "90vw" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-gradient-brand opacity-30 blur-3xl animate-pulse-ring" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-4 rounded-full border border-cyan-glow/30 animate-spin-slow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-10 rounded-full border border-blue-glow/40 animate-spin-reverse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-2 rounded-full", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "relative w-[78%] h-[78%] rounded-full overflow-hidden shadow-cyan animate-float-orb",
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Richard Martinez - Senior Software Engineer", className: "w-full h-full object-cover" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-tr from-blue-glow/20 via-transparent to-cyan-glow/20" })
            ]
          }
        ),
        [0, 72, 144, 216, 288].map((deg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-spin-slow", style: { animationDuration: `${10 + i * 2}s`, transform: `rotate(${deg}deg)` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-cyan-glow shadow-[0_0_20px_oklch(0.85_0.15_200)]" }) }, i))
      ] }) })
    ] })
  ] });
}
